...
public class LiveListViewModelFactory  extends ViewModelProvider.AndroidViewModelFactory {
     ...
     */
    public LiveListViewModelFactory(@NonNull Application application, LifecycleOwner lifecycleOwner) {
        super(application);
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new LiveListViewModel(new LiveListRepository(lifecycleOwner, context));
    }
}
