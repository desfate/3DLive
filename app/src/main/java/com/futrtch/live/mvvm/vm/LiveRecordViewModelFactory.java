...
public class LiveRecordViewModelFactory extends ViewModelProvider.AndroidViewModelFactory {
     ...
     */
    public LiveRecordViewModelFactory(@NonNull Application application, LifecycleOwner lifecycleOwner) {
        super(application);
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new LiveRecordViewModel(new LiveRoomRepository(lifecycleOwner));
    }
}
